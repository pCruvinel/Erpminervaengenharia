...
export function OSTable({ ordensServico, canViewSetorColumn, onNavigate }: OSTableProps) {
      ...
      <Table>
        ...
        <TableBody>
          {ordensServico.length === 0 ? (
            <TableRow>
              <TableCell
                colSpan={canViewSetorColumn ? 8 : 7}
            ...
            ordensServico.map((os) => (
              <TableRow key={os.id}>
                ...
                <TableCell>
                  <span
                    className={
                      isOverdue(os.dataPrazo, os.status)
                        ? 'text-[rgb(239,68,68)]'
                        : ''
                    }
                  >
                    {formatDate(os.dataPrazo)}
                  </span>
                </TableCell>
